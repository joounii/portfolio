...
export default function Create({ auth }: { auth: any }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        status: '',
        tags: [] as string[],
        status_color: 'text-admin-success bg-admin-success/10',
        tagInput: '',
    });
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-10">
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {/* Unified Action Bar with Back Button */}
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
                        <div>
                            ...
                            <p className="text-sm text-admin-on-surface-variant mt-1">
                                Create a new system dossier and configure its initial metadata.
                            </p>
                        </div>
                    ...
                    <div className="bg-admin-surface-container overflow-hidden shadow-sm sm:rounded-xl border border-admin-outline-variant/30">
                        <form onSubmit={handleSubmit} className="p-8 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="custom_id" className={labelClass}>System ID (e.g. #OC_01)</label>
                                    <input
                                        type="text"
                                        id="custom_id"
                            ...
                            {/* Description */}
                            <div>
                                <label htmlFor="description" className={labelClass}>Short Description (Card Text)</label>
                                <textarea
                                    id="description"
                                    className={inputClass}
                                    rows={3}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="status" className={labelClass}>Status Label (e.g. STABLE)</label>
                                    <input
                                        type="text"
                                        id="status"
                                        className={inputClass}
